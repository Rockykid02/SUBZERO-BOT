...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~yBxwGQra#9nfyWEUZsfkeQytm6pL17-GSwXmuIJnFcrsHVugdAfM",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "SAGE DICKSON-MD",
...
OWNER_NAME: process.env.OWNER_NAME || "Mr Sage Dickson",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© DigitalDynamoLab*",
// add bot owner name    
